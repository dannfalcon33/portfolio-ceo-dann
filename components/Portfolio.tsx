    ...
    <SectionWrapper id="portfolio">
      <div className="flex flex-col h-full justify-center">
        <div className="flex justify-between items-center mb-12">
           <h2 className="font-serif text-4xl md:text-5xl text-luxury-white">Selected Works</h2>
           <span className="text-xs tracking-widest text-luxury-gray uppercase hidden md:block">Scroll to explore</span>
        </div>
          ...
          {PROJECTS.map((project) => (
            ...
            >
              ...
              <div className="mt-4 flex justify-between items-start border-t border-luxury-border pt-4 group-hover:border-luxury-border-strong transition-colors duration-500">
                <div>
                  <h3 className="font-serif text-xl md:text-2xl mb-1 text-luxury-white">{project.title}</h3>
                  <p className="text-xs tracking-widest text-luxury-gray uppercase">{project.category}</p>
                </div>
                <span className="font-mono text-xs text-luxury-gray">{project.year}</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-12 text-center md:text-right">
             <a href="#" className="text-xs tracking-[0.2em] uppercase border-b border-transparent hover:border-luxury-white transition-all pb-1 text-luxury-white">View Full Archive</a>
        </div>
      </div>
          ...
          >
            ...
            >
              ...
              <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
                 ...
                 <h2 className="font-serif text-4xl md:text-5xl mb-6 text-luxury-white">{selectedProject.title}</h2>
                 ...
                 <p className="font-sans text-sm leading-loose text-luxury-gray mb-10 text-justify">
                   {selectedProject.description || "Project description currently unavailable. Please check back later for case study details."}
                 </p>
                 ...
                 <div className="mt-auto">
                    {selectedProject.link && (
                      ...
                      >
                         <span className="relative z-10 text-xs tracking-widest uppercase text-luxury-white group-hover:text-luxury-white-inverse">View Live Project</span>
                         <ArrowUpRight size={16} className="relative z-10 text-luxury-white group-hover:text-luxury-white-inverse group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform duration-300" />
