    ...
    <SectionWrapper id="skills">
      <div className="w-full max-w-6xl mx-auto">
        <div className="flex justify-between items-end mb-16 border-b border-luxury-border-strong pb-4">
          <h2 className="font-serif text-5xl md:text-7xl text-luxury-white">Expertise</h2>
          <span className="font-serif text-xl md:text-3xl text-luxury-gray">02</span>
        </div>
              ...
              <ul className="space-y-4">
                {category.skills.map((skill, sIdx) => (
                  <motion.li 
                    ...
                    transition={{ delay: idx * 0.2 + sIdx * 0.1, duration: 0.5 }}
